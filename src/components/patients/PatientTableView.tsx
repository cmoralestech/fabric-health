...
import { User, Calendar, Phone, Mail, Activity, Eye, UserPlus, ArrowRight } from 'lucide-react'
...
export default function PatientTableView({ patients, onViewPatient, onScheduleSurgery }: PatientTableViewProps) {
    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
      ...
      {hasScroll && (
        <div className="bg-blue-50 border-b border-blue-200 px-4 py-2 flex items-center justify-center text-blue-700">
          ...
          <span className="text-sm">Scroll horizontally to see all columns</span>
                  ...
                  <tr key={patient.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-3 py-3 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="ml-2 min-w-0">
                          <div className="text-sm font-medium text-gray-900 truncate max-w-[100px]" title={patient.name}>
                            {patient.name}
                          </div>
                    ...
                    <td className="px-3 py-3 whitespace-nowrap text-center">
                      <div className="space-y-1">
                        <span className={`inline-flex items-center px-1.5 py-0.5 rounded text-xs font-medium ${ageCategory.color}`}>
                      ...
                      <div className="space-y-1">
                        {patient.email && (
                          <div className="flex items-center text-xs text-gray-600">
                            ...
                            <span className="truncate max-w-[80px]" title={patient.email}>
                    ...
                    <td className="px-3 py-3 whitespace-nowrap text-right">
                      <div className="flex items-center justify-end gap-1">
                        <Button
                          variant="outline"
                          size="sm"
                          className="hover:bg-slate-50 hover:border-slate-300 px-2 py-1 text-xs"
                        ...
                        <Button
                          variant="outline"
                          size="sm"
                          className="hover:bg-blue-50 hover:border-blue-300 hover:text-blue-700 px-2 py-1 text-xs"
